...
\begin{itemize}
  ...
  \begin{itemize*}
    \item At PredictAP I imeplemnted the proof of concept that became our core platform including AI/ML/CS prediction engine and SaaS product.
    \item Designed, implemented, maintain, and enhance application platform and underlying infrastructure on top of AWS.
    ...
    \item Keywords: Python, AWS, AI/ML, React, Kubernetes, Terraform, Data Pipelines, Data Warehousing, Leadership
  \end{itemize*}
  ...
  \begin{itemize*}
    ...
    \item Keywords: Golang, Kubernetes, Consul, AWS, Azure, Google Cloud, Observability
  \end{itemize*}
  ...
  \begin{itemize*}
    ...
    \item Keywords: Golang, RPC, OAuth / Identity, Google Cloud, AWS, Game Server Development, iOS, Android, NFC, Hardware/Firmware, Leadership
  \end{itemize*}
  ...
  \begin{itemize*}
    ...
    \item Keywords: Typescript, Node, AWS, C\#, .Net Core, Docker, Leadership
  \end{itemize*}
...
Technical
\begin{itemize*}
        \item 8+ years of DevOps experience
