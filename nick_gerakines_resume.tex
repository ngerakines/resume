...
\begin{itemize}
  ...
  \headerrow
    {\textbf{Mattel}}
    {\textbf{San Francisco, CA | East Aurora, NY}}
  \\
  \headerrow
    {\emph{Principal Software Engineer | Platform Engineering Manager}}
    {\emph{May 2017 -- Present}}
  \begin{itemize*}
    \item At Mattel, I lead the Sproutling platform team to support the Sproutling product and other IoT initiatives and products at Matel.
    \item My responsabilities include working with other groups within Mattel to understand project scope and requirements, provide software development guidance to team members, and support the business at large
  \end{itemize*}
  ...
  \\
  \headerrow
    {\emph{Director of Engineering}}
    {\emph{September 2014 -- May 2017}}
  \begin{itemize*}
    \item At Colibri Learning, I am the Director of Engineering and oversee the technical design and implementation of our product offerings.
